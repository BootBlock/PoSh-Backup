@{
  ...
  conversation_summary            = @(
    ...
    "",
    "--- Feature: Pre-Flight Check Mode (Completed in Previous Session) ---",
    ...
    "",
    "--- UX & Reliability Polish (Completed in Previous Session) ---",
    ...
    "",
    "--- Refactor: Centralised Configuration Defaults (Completed in Previous Session) ---",
    ...
    "",
    "--- Feature: Automated Self-Update Process (Completed in Previous Session) ---",
    ...
    "",
    "--- Feature: Add Build/Commit Identifier (Completed in Previous Session) ---",
    ...
    "",
    "--- Refactor: Modularise ScheduleManager (Completed in Previous Session) ---",
