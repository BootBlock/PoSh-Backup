@{
  ...
  ai_development_watch_list       = @(
    ...
    "STRUCTURE: Respect modular design (Core, Managers, Utilities, etc.). `Write-LogMessage` is now in `Modules\\Utilities\\Logging.psm1`.",
  ...
  conversation_summary            = @(
    ...
    "   - **Implementation:**",
    "     - Created a new utility module: `Modules\\Utilities\\Logging.psm1`.",
    "     - Moved the `Write-LogMessage` function from the `LogManager` sub-module into this new utility module.",
    "     - Updated the `Utils.psm1` facade to point to the new location.",
    "     - Simplified the `LogManager.psm1` facade to focus solely on log retention.",
    "     - Deleted the now redundant `Modules\\Managers\\LogManager\\Logger.psm1` file.",
    "",
