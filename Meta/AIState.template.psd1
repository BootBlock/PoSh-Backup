...
@{
  ...
  ai_development_watch_list = @(
    ...
    "DATA FLOW: Ensure data for reports (like `IsSimulationReport`, `OverallStatus`) is correctly set in `theReportDataRefVariable` (a ref object) *before* report generation functions are called.",
