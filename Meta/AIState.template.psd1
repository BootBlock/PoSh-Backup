@{
  ...
  conversation_summary            = @(
    ...
    "",
    "--- Refactor: Centralised Configuration Defaults (Current Session) ---",
    ...
    "",
    "--- Feature: Automated Self-Update Process (Current Session) ---",
    ...
    "",
    "--- Feature: Add Build/Commit Identifier (Current Session) ---",
