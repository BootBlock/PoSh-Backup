...
function Invoke-XmlReport {
    ...
    .PARAMETER ReportData
        ...
        any 'TargetTransfers' and checksum data. This entire hashtable (cast to PSCustomObject) will be
    ...
    .EXAMPLE
        ...
        #     JobName         = "MyJob"
        #     ReportData      = $JobReportDataObject # This object now contains TargetTransfers & ChecksumInfo if applicable
        ...
        # $checksumValue = $importedData.ArchiveChecksum
    .OUTPUTS
    ...
    try {
        ...
        # The TargetTransfers array and Checksum fields will be serialised as part of this object.
