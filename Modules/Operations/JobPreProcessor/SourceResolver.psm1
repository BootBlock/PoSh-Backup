...
.DESCRIPTION
    This module provides the 'Resolve-PoShBackupSourcePaths' function. It contains the
    ...
    configuration. It returns the final paths that 7-Zip should use.
.NOTES
...
try {
    ...
    Import-Module -Name (Join-Path $PSScriptRoot "..\..\Utils.psm1") -Force -ErrorAction Stop # For Test-AdminPrivilege
}
catch {
    Write-Error "SourceResolver.psm1 FATAL: Could not import a dependent module. Error: $($_.Exception.Message)"
    throw
}
#endregion
